    ...
    <main className="min-h-screen pt-32 pb-20 bg-[#F8FAEE]">
      <section className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-10">
        ...
        >
          ...
          <div className="mt-8 pt-8 border-t border-[#F8FAEE]/10">
            <h3 className="font-serif text-xl mb-4 text-[#F8FAEE]/90">Our Supporting Partners</h3>
            <div className="flex items-center gap-4">
              <div className="bg-white/10 px-6 py-3 rounded-xl border border-white/20 backdrop-blur-sm">
                <span className="font-serif text-lg tracking-wide text-white">Hoffnungsschatze</span>
                <p className="text-xs text-[#CFE36E] mt-0.5 uppercase tracking-wider font-medium">Strategic Partner</p>
              </div>
            </div>
          </div>
        </motion.aside>
