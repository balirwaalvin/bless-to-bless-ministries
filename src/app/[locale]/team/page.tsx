...
const globalTeam: typeof ugandanTeam = [
  {
    name: "Paris Parie",
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {globalTeam.length > 0 ? (
            ...
            {globalTeam.map((member, idx) => (
              ...
              >
                {member.image ? (
                  ...
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#D8D7E5] to-[#E8E0CF] flex items-center justify-center text-[#202612] font-serif text-2xl mb-5">
                    {member.initials}
                  </div>
                )}
                <h2 className="text-2xl font-serif text-[#202612]">{member.name}</h2>
          ...
          <div className="text-center text-[#202612]/50 italic">
            Global team members to be announced soon.
          </div>
        )}
      </section>
    </main>
